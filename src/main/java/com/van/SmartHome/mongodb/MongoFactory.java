...
import com.van.SmartHome.converter.DateToLongConverter;
import com.van.SmartHome.converter.LongToDateConverter;
import com.van.SmartHome.converter.StringToDateConverter;
...
import static com.van.SmartHome.mongodb.DBNames.SYSTEM;
...
public class MongoFactory implements Serializable {
    ...
    public MongoFactory(MongoClient mongo) {
        log.info("!!!MongoFactory struct mongo:{}",mongo);
        this.mongo = mongo;
